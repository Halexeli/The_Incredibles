...
class Texte{
    ...
    std::string texte;
    public:
    Texte():x(0),y(0),font_file("../../Assets/Times_New_Roman/times_new_roman.ttf"),color(0xFF0000FF),texte("pas de texte encore"),taille(12){};
    Texte(float _x,float _y,int _taille=12,uint32_t _color=0xFF0000FF,std::string _texte="pas de texte encore",std::string _front="../../Assets/Times_New_Roman/times_new_roman.ttf"):x(_x),y(_y),font_file(_front),color(_color),texte(_texte),taille(_taille){};
